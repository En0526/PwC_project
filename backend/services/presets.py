...
def get_presets() -> list[Preset]:
    ...
    return [
        ...
        Preset(
            id="mentor-ntbna-news-rss",
            name="財政部－北區國稅局 RSS",
            url="https://www.ntbna.gov.tw/Rss/374fe8c4b18e48c691a6806ac02b9984",
            frequency="業師提供",
            check_interval_minutes=30,
            watch_description="RSS 格式，追蹤財政部北區國稅局「本局新聞稿」最新新聞標題、發布時間與連結。",
        ),
        Preset(
            id="mentor-moea-news",
            name="經濟部－本部新聞",
            ...
            frequency="業師提供",
            check_interval_minutes=30,
            watch_description="只監測「首頁 > 新聞與公告 > 本部新聞」列表。Agent 1 請穩定擷取新聞列表中的日期、標題、發布單位與時間；Agent 2 整理最新日期的新聞與新增項目。",
        ),
        Preset(
            id="mentor-moea-news-rss",
            name="經濟部－本部新聞 RSS",
            url="https://www.moea.gov.tw/MNS/populace/news/NewsRSSdetail.aspx?Kind=1",
            frequency="業師提供",
            check_interval_minutes=30,
            watch_description="RSS 格式，追蹤「首頁 > 新聞與公告 > 本部新聞」最新新聞標題、發布時間與連結。",
        ),
        Preset(
        ...
        Preset(
            ...
            frequency="業師提供",
            check_interval_minutes=30,
            watch_description="對應官網側欄「最新消息 > 新聞發布」主列表；不含「產業大小事」。摘要會顯示「經濟部產業發展署更新｜新聞發布」語意等同此欄目。若要 RSS 並願區分類別請用下列「RSS（t=1）」preset。",
        ),
        Preset(
            id="mentor-ida-rss",
            name="經濟部產業發展署－RSS t=1（新聞發布／產業大小事）",
            url="https://www.ida.gov.tw/ctlr?PRO=rss.RSSView&t=1",
            frequency="業師提供",
            check_interval_minutes=30,
            watch_description="官方 RSS endpoint t=1。稿件可能混有「首頁>新聞發布」與「首頁>產業大小事」；系統依每則稿件（NewsView 連結會對照內文頁麵包屑、快取結果）自動分類，通知摘要分列為「⋯更新｜新聞發布」或「⋯更新｜產業大小事」。若只要新聞發布欄請用「經濟部產業發展署－新聞發布」網頁訂閱。",
        ),
        Preset(
